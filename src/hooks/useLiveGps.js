...
import { projectOntoRoute } from "../lib/geo.js";
...
/* =========================================================
   ...
   starts. onMove([lat, lng]) is called for every fix.
========================================================= */

export function useLiveGps({ routePoints, stepCount, onMove }) {
  ...
  return { active, position, accuracy, offRoute, remaining, stepIndex, start, stop };
}
